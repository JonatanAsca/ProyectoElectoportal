...
class Votantes extends Component {
    ...
    peticionPost = async () => {
        try {
            console.log('Creando votante:', this.state.form); // Log para depuración
    ...
    peticionPut = async () => {
        try {
            console.log('Actualizando votante:', this.state.form); // Log para depuración
    ...
    peticionDelete = async () => {
        try {
            console.log('Eliminando votante:', this.state.form.Cedula); // Log para depuración
    ...
    seleccionarVotante = (votante) => {
        this.setState({
            ...
            form: {
                ...
                Nombre: votante.NombreVotantes, 
                Apellido: votante.Apellido,
                Telefono: votante.Telefono,
                Correo: votante.Correo,
                Id_barrio: votante.Id_barrio,
                Id_mesa_votacion: votante.Id_mesa_votacion,
                Id_puesto_votacion: votante.Id_puesto_votacion,
                Id_digitadores: votante.Id_digitadores
            }
        });
    ...
    */
    ...
    render() {
        ...
        return (
            <div className='App'>
                <br />
                <button className='btn btn-success' onClick={() => this.modalInsertar()}>Agregar Votante</button>
                <br /><br />
                    ...
                    <tbody>
                        {this.state.data.map(votante => (
                            <tr key={votante.Cedula}>
                                ...
                                <td>
                                    <button className="btn btn-primary" onClick={() => { this.seleccionarVotante(votante); }}><FontAwesomeIcon icon={faEdit} /></button>
                                    {"   "}
