        ...
        <div className="dashboard-container">
            <nav className="navbar">
                ...
                <ul className="nav-list">
                    <li><NavLink to="/dashboard_digitador" activeClassName="active-link" className="nav-link">Inicio</NavLink></li>
...
export default Dashboard_digitador; 
